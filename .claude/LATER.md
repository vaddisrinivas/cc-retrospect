...
- [x] (P0) update dispatch map tests for 25 routes / 7 hooks
- [x] (P1) add cc_retrospective/ to .gitignore
- [x] (P1) delete stale ~/.cc-sentinel/ data dir
...
- [x] (P2) add /uninstall command — remove hooks from settings.json
...
- [x] (P2) hooks.json: verified PreCompact/PostCompact event names are correct PascalCase
- [x] (P2) hybrid skills: /waste, /savings, /model, /health, /digest — Python precision + Claude reasoning layer
- [x] (P3) add py.typed marker
- [x] (P3) add GitHub release workflow (tag → build → publish)
